...
################################
if (NOT TARGET camp)
   find_package(camp QUIET NO_DEFAULT_PATH PATHS ${CAMP_DIR})
...
if (NOT TARGET umpire)
   find_package(umpire QUIET NO_DEFAULT_PATH PATHS ${UMPIRE_DIR})
...
################################
if (NOT TARGET RAJA)
   find_package(raja QUIET NO_DEFAULT_PATH PATHS ${RAJA_DIR})
...
################################
if (NOT TARGET chai)
   find_package(chai QUIET NO_DEFAULT_PATH PATHS ${CHAI_DIR})
...
if (NOT TARGET LLNL_GlobalID::LLNL_GlobalID)
   if (LLNL_GLOBALID_DIR)
      find_package(LLNL_GlobalID REQUIRED NO_DEFAULT_PATH PATHS ${LLNL_GLOBALID_DIR})
...
if (ENABLE_CUDA AND NOT TARGET cub)
   include(${CMAKE_CURRENT_LIST_DIR}/libraries/FindCUB.cmake)
endif ()
