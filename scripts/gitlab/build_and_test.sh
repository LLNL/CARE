...
###############################################################################
# Copyright (c) 2016-25, Lawrence Livermore National Security, LLC and CARE
...
ci_registry_image=${CI_REGISTRY_IMAGE:-"czregistry.llnl.gov:5050/radiuss/care"}
...
then
    ...
    timed_message "CARE built and installed"
fi
...
then
    ...
    timed_message "CARE tests completed"
fi
