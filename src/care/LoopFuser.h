...
#define FUSIBLE_LOOP_COUNTS_TO_OFFSETS_SCAN_PHASE_R(INDX,START,END,SCANVAR, PHASE, REGISTER_COUNT) SCAN_COUNTS_TO_OFFSETS_LOOP(INDX, START, END, SCANVAR)
#define FUSIBLE_LOOP_COUNTS_TO_OFFSETS_SCAN_PHASE(INDX,START,END,SCANVAR, PHASE) SCAN_COUNTS_TO_OFFSETS_LOOP(INDX, START, END, SCANVAR)
